            ...
            <div class="card horizontal light-blue darken-4">
                ...
                <div class="card-stacked">
                    <div class="card-content">
                        <div class="col s12 l10 hide-on-small-only">
                    ...
                    <div class="card-action">
                        <div class="valign-wrapper">
                            <a href="{{url("/navegacion/verPerfilAjeno/".$usuario->nick)}}"
                               class="white-text">{{$usuario->nick}}</a>
                            <a href="{{url("/navegacion/verPerfilAjeno/".$usuario->nick)}}" class="white-text"> <i
...
<script src="{{url("/public/js/buscarusuario/ini.js")}}"></script>

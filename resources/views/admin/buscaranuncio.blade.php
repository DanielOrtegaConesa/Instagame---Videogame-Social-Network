...
<div class="row">
    @foreach($anuncios as $anuncio)
        <div class="col s12 m6" id="{{$anuncio->cod}}">
            <div class="card">
                ...
                <div class="card-action">
                    <a href="/admin/navegacion/editarAnuncio/{{$anuncio->cod}}">Editar</a>
                    <a id="{{$anuncio->cod}}eliminar" href="#" id="eliminarAnuncio">Eliminar</a>
                </div>

                <script>
                    $("#{{$anuncio->cod}}eliminar").click(function () {
...
<script src="{{url("/public/js/admin/buscaranuncio/ini.js")}}"></script>
<script src="{{url("/public/js/admin/buscaranuncio/ajax.js")}}"></script>
